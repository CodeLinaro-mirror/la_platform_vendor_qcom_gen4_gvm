TARGET_BOARD_PLATFORM := gen4
TARGET_BOOTLOADER_BOARD_NAME := gen4
...
ifeq (,$(filter gen4_gvm_cmu, $(TARGET_BOARD_PLATFORM)$(TARGET_BOARD_SUFFIX)$(TARGET_BOARD_DERIVATIVE_SUFFIX)))
PRODUCT_COPY_FILES += \
    device/qcom/gen4_gvm/input-port-associations.xml:$(TARGET_COPY_OUT_VENDOR)/etc/input-port-associations.xml \
...
#PRODUCT_COPY_FILES += \
#    device/qcom/gen4_gvm/gen4_gvm_excluded_features.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/gen4_gvm_excluded_features.xml
